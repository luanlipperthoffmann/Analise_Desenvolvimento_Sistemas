...
// FOR============================
    int i, soma = 0;
    System.Console.WriteLine("Os dez primeiros numeros naturais sao:");
    for (i=1; i<11; i++)
    {
        soma +=i;
        System.Console.WriteLine($"{i}");
...
// VER IMAGEM NA TDE
    ...
    System.Console.WriteLine("Qual tipo de operador desejas usar: (+, -, *, /)");
    ...
    switch(operador)
    {
        ...
        default:
        System.Console.WriteLine("Operador Ínvalido");
        break;
    }
    System.Console.WriteLine($"{num1} {operador} {num2} = {resposta}");
*/